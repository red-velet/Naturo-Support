      ...
      '/introduce/': [
        {
          text: '游戏玩法介绍',
          items: [
            { text: '决斗场', link: '/introduce/决斗场' },
            { text: '小队突袭', link: '/introduce/小队突袭' },
            { text: '组织', link: '/introduce/组织' },
            { text: '任务集会所', link: '/introduce/任务集会所' },
            { text: '忍话剧', link: '/introduce/忍话剧' },
            { text: '积分赛', link: 'introduce/积分赛' },
            { text: '战区赛事', link: '/introduce/战区赛事' },
            { text: '忍者大赛', link: '/introduce/忍者大赛' },
            { text: '丰饶之间', link: '/introduce/丰饶之间' },
            { text: '忍者挑战', link: '/introduce/忍者挑战' },
            { text: '小队突袭', link: '/introduce/小队突袭' },
            { text: '试炼之地', link: '/introduce/试炼之地' },
            { text: '招募', link: '/introduce/招募' },
            { text: '活动', link: '/introduce/活动' },
            { text: '商店', link: '/introduce/商店' },
            { text: '奖励', link: '/introduce/奖励' },
            { text: '忍法帖', link: '/introduce/忍法帖' },
            { text: '探险', link: '/introduce/探险' },
            { text: '功能手册', link: '/introduce/功能手册' },
          ]
        },
      ],
      '/guide/': [
